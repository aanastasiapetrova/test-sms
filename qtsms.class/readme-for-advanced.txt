...
Если вы хотите ее включить, то ниже приведен один из рабочих вариантов:
  ...
  3. Убедиться, что опция curl: CURLOPT_SSL_VERIFYPEER установлена в TRUE
...
------------------
Примечания:
- не забывайте уничтожать объект SmsAction после использования,
  это актуально при создании большого количества объектов SmsAction
